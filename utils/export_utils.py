"""DXF-to-image export using PIL compositing for guaranteed background control.

(Formerly export_utils_v2.py; the older matplotlib-savefig-only variant it
replaced was removed as dead code.)
"""
